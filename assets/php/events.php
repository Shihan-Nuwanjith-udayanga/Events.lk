...
<!--End header-->
<main>
    <!--    create events category area start-->
    <section>
        <aside>
            <div><a href="">
    ...
    <!--    create events category area End-->
